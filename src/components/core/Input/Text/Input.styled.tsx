  ...
  ${(props) => {
    ...
    switch (mode) {
      case "light":
        return `
        svg {
          fill: ${disabled ? neutral["gray-5"] : getInputBorderColor(props, neutral["gray-6"])};
        }
      ...
      case "dark":
        return `
        svg {
          fill: ${disabled ? neutral["gray-9"] : getInputBorderColor(props, neutral["gray-8"])};
        }
        ...
        &:hover {
          svg {
            fill: ${disabled ? neutral["gray-9"] : getInputBorderColor(props, neutral["gray-7"])};
          }
        }
    `;
    }
